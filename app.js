(function() {
    ...
    emoji: '🌓', 
colors: [
  "#000000", "#2B1B34", "#4A2A43", "#6A3A51", "#8B4B5F", "#AE5C6D",
  "#2E3B4E", "#4E596C", "#6D788A", "#8D97A8", "#ADC6C7", "#CDE5E6",
  "#2F4F4F", "#4A6A6A", "#648585", "#7FA0A0", "#9ACBCB", "#B5E5E5",
  "#4B4453", "#6A6273", "#8A8093", "#AA9EB3", "#CAC6D3", "#EAE4F3",
  "#5A4F41", "#7A6F61", "#9A8F81", "#BAAF91", "#DACFA1", "#F9F0C1",
  "#6B4226", "#8B6246", "#AB8266", "#CBA286", "#EBC2A6", "#FFD2B6",
  "#1E5151", "#3E7171", "#5D9191", "#7DB1B1", "#9DD1D1", "#BDF1F1",
  "#2E2363", "#4E4383", "#6D63A3", "#8D83C3", "#ADE3E3", "#FFFFFF"
]
